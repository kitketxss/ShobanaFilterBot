...
API_ID = int(environ.get('API_ID', '12077452'))
API_HASH = environ.get('API_HASH', 'd0cb0814fd2775b250f644f44c8eaa39')
BOT_TOKEN = environ.get('BOT_TOKEN', '8346998798:AAEsbRLKCPi6UVJ6SO6v1sGect6v9QeLZzg')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8336342269').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003017012354').split()]
...
FILE_CHANNELS = [int(ch) for ch in environ.get('FILE_CHANNELS', '-1003017012354').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', Others))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mnbots_support')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', 'False')), Fas_enabled((environ.get('IMDB', 'False')), False)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'ggggg')).split()]
